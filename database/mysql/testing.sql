...
/* New AI entry*/
CALL sow_new_ai_entry(342298, 2, 3, '2024-09-10', 'AI PIC 337');

CALL sow_new_ai_entry(342271, 2, 2, '2024-11-03', 'AI PIC 337');

CALL sow_new_ai_entry(342265, 2, 2, '2024-11-03', 'AI PIC 337');

CALL sow_new_ai_entry(342271, 2, 2, '2025-01-06', 'AI PIC 337');
