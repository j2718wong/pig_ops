...
ERROR_ACC_GESTATING_OPS_INVALID_NUMDAYS             = 0x61
ERROR_ACC_GESTATING_OPS_INVALID_USER_HASHID         = 0x62
ERROR_ACC_GESTATING_OPS_INVALID_HASHID              = 0x63
ERROR_ACC_GESTATING_OPS_INVALID_ACCOUNT_HASHID      = 0x64


ERROR_PIG_RACE_LINE_INVALID_NAME                    = 0x70
ERROR_PIG_RACE_LINE_INVALID_USER_HASHID             = 0x71
ERROR_PIG_RACE_LINE_INVALID_HASHID                  = 0x72


ERROR_SEMEN_SUPPLIER_INVALID_NAME                   = 0x80
ERROR_SEMEN_SUPPLIER_INVALID_USER_HASHID            = 0x81