...
async def prod_gestating_ops_update(prod_gestating_ops_data: dm.DataProdGestatingOps):
    ...
    staff_hid = prod_gestating_ops_data.staff_hid
    staff_id  = None
...
async def prod_gestating_ops_list(prod_hid: str, inc_user_audit:int = 0):
    ...
    for cur_entry in res:
        cur_id  = cur_entry['prod_gestating_ops']['id']
        cur_hid = hashids_common.encrypt(cur_id)
        
        del cur_entry['prod_gestating_ops']['id']
        cur_entry['prod_gestating_ops']['hid']   = cur_hid
