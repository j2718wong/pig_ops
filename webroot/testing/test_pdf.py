...
def create_sample_data():
    ...
    # Make sure all required lists exist even if empty
    context = {
        'pig_farm_info': pig_farm_info,
        'acc_settings_ops': acc_settings_ops,
        'list_gestating': list_gestating,  # Your existing gestating sows
        'list_lactating': [],  # Add empty list for lactating
        'list_fattening': [],  # Add empty list for fattening
        'inc_historical': False,
        'inc_cost': False,
        'inc_target_harvest': False
    }
